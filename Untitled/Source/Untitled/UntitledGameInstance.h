...
#include "UntitledGameInstance.generated.h"

/**
 * 
 */
UCLASS()
class UNTITLED_API UUntitledGameInstance : public UGameInstance, public IMenuInterface
{
	GENERATED_BODY()
public:
	/** Contructor with objectInitializer to use constructor helper and find the correct blueprint class*/
	UUntitledGameInstance(const FObjectInitializer & ObjectInitializer);
